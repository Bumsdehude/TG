...
*/
UCLASS()
class UMypluginBPLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_UCLASS_BODY()


	UFUNCTION(BlueprintPure, meta = (DisplayName = "GetClassByName", Keywords = "Get Class By Name"), Category = "MypluginTesting")
	...
	UFUNCTION(BlueprintCallable, Category = "MyGame", meta = (WorldContext = "WorldContextObject"))
		static bool CloneFile(FString FilePath, FString Source);
	UFUNCTION(BlueprintCallable, Category = "MyGame", meta = (WorldContext = "WorldContextObject"))
		static bool MakeFolder(FString FilePath);
	UFUNCTION(BlueprintCallable, Category = "MyGame", meta = (WorldContext = "WorldContextObject"))
		static bool DeleteFile(FString FilePath, bool EvenIfReadOnly);
	UFUNCTION(BlueprintCallable, Category = "MyGame", meta = (WorldContext = "WorldContextObject"))
		static bool DoesFolderExist(FString FilePath);
	UFUNCTION(BlueprintCallable, Category = "MyGame", meta = (WorldContext = "WorldContextObject"))
		static bool DeleteFolder(FString FilePath, bool EvenIfReadOnly, bool Tree);
